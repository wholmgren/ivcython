...
#define __PYX_HAVE__cython_zeros
#define __PYX_HAVE_API__cython_zeros
#include "zeros.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
#define __Pyx_MODULE_NAME "cython_zeros"
extern int __pyx_module_is_main_cython_zeros;
int __pyx_module_is_main_cython_zeros = 0;

/* Implementation of 'cython_zeros' */
...
static int __pyx_pymod_exec_cython_zeros(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_zeros},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcython_zeros(void); /*proto*/
PyMODINIT_FUNC initcython_zeros(void)
#else
PyMODINIT_FUNC PyInit_cython_zeros(void); /*proto*/
PyMODINIT_FUNC PyInit_cython_zeros(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_cython_zeros(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cython_zeros(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_zeros", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cython_zeros) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cython_zeros")) {
      if (unlikely(PyDict_SetItemString(modules, "cython_zeros", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  __pyx_t_1 = __Pyx_ImportModule("newton"); if (!__pyx_t_1) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "newton", (void (**)(void))&__pyx_f_6newton_newton, "double (__pyx_t_6newton_callback_type_tup, double, __pyx_t_6newton_callback_type_tup, PyObject *)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cython_zeros", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_zeros");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
